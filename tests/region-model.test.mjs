...
test('shift/free drag bypasses snap',()=>assert.deepEqual(regionFromDrag(4.13,9.77,{viewDuration:60,bpm:120,snapMode:'bar',free:true}),{start:4.13,end:9.77,duration:5.64}));
