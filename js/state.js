...
export const state={mode:'select',bpm:120,dirty:false,playing:false,audioCtx:null,sources:[],selected:null,showBeats:true,showDownbeats:true,installPrompt:null,rendering:false,viewDuration:60,tracks:[makeTrack(0,'TRACK A'),makeTrack(1,'TRACK B')]};
